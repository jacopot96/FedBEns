...
class FedNet(nn.Module):
    def __init__(self, bias = True, n_out=10):
        bias=False
        ...
        self.fc1 = nn.Linear(64*5*5, int(512/factor), bias=bias)
        self.fc2 = nn.Linear(int(512/factor), int(128/factor), bias=bias)
        self.fc3 = nn.Linear(int(128/factor), n_out, bias=bias)
